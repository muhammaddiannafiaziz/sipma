                                        ...
                                        <div class="mb-3 mb-4">
                                            ...
                                            @if (auth()->user()->profile->no_hp != null)
                                                <input type="number" class="form-control" id="basicpill" name="nohp"
                                                    placeholder="Masukkan Tanggal Lahir" value="{{ auth()->user()->profile->no_hp }}" required disabled>
                                            @else
                                                <input type="number" class="form-control" id="basicpill" name="nohp"
                        ...
                        <a href="#school-data" class="collapsed text-dark" data-bs-toggle="collapse">
                            <div class="p-4">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1 overflow-hidden">
                                        <h5 class="font-size-16 mb-1">Data riwayat sekolah asal</h5>
                                        <p class="text-muted text-truncate mb-0">Sekolah asal, ijazah</p>
                                    </div>
                                    <div class="flex-shrink-0"> <i
                                            class="mdi mdi-chevron-up accor-down-icon font-size-24"></i> </div>
                                </div>
